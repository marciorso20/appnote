...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps){
  ...
  function handleContentChanged(event: ChangeEvent<HTMLTextAreaElement>){
    setContent(event.target.value) //atualiza o valor do estado
  ...
  return(
    <Dialog.Root>
       <Dialog.Trigger className='rounded-md flex flex-col bg-slate-700 text-left p-5 gap-3 outline-none hover:ring-2 hover:ring-slate-600
        ...
        <Dialog.Portal>
            ...
            <Dialog.Content className='
              fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 
            ...
            >
              ...
              <Dialog.Close 
                className='
                  absolute right-0 top-0 bg-slate-800 p-1.5 
              ...
              <form  className='flex-1 flex flex-col'>
                ...
                {isRecording ? (
                   <button 
                    ...
                    className='
                      w-full flex items-center justify-center gap-2 bg-slate-900 py-4 text-center 
                  ...
                  <button 
                    ...
                    className='
                      w-full bg-lime-400 py-4 text-center 
                      text-sm text-lime-950 outline-none
